...
@section('content')
  <div id="wrapper" class="pt-3 col-12 col-sm-12 col-md-8 col-xl-8">
    ...
    <form method="POST" action="/folder/release">
      ...
      {{-- hiddenでidをコントローラに送る --}}
      <input type="hidden" class="form-control" name="todo_id" value="{{$todo->id}}">
      <input type="hidden" class="form-control" name="folder_id" value="{{$fold->id}}">

      {{-- 各種ボタン --}}
      <input type="submit" readonly class="btn btn-warning" value="フォルダから削除">
