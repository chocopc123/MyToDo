...
@section('content')
  ...
  <div class="col-12 col-sm-12 col-md-3 col-xl-2 order-md-first" style="background-color: #e3f2fd;">
    <ul class="list-group">
      ...
      <a href="/add_folder_form/{{ $fold->id }}" class="list-group-item list-group-item-action font-weight-bold <?php if($completed == false){ echo "active"; } ?>">未達成</a>
      <a href="/add_folder_completed_form/{{ $fold->id }}" class="list-group-item list-group-item-action font-weight-bold <?php if($completed == true){ echo "active"; } ?>">達成済み</a>
    </ul>
    <ul class="list-group">
