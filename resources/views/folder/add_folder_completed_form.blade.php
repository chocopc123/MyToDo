@section('sidebar')
  <ul class="list-group">
    ...
    <a href="/add_folder_form/{{ $fold->id }}" class="list-group-item list-group-item-action font-weight-bold">未達成</a>
    <a href="/add_folder_completed_form/{{ $fold->id }}" class="list-group-item list-group-item-action font-weight-bold active">達成済み</a>
  </ul>
  <ul class="list-group">
